...
@Component({
  selector: 'app-traitement-par-boc',
  templateUrl: './traitement-par-boc.component.html',
  styleUrls: ['./traitement-par-boc.component.scss']
})
export class TraitementParBOCComponent implements OnInit {
