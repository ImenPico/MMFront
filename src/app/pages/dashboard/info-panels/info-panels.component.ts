...
export class InfoPanelsComponent {
  ...
  public sales = [{ name:'courrier Arrivés', value:5 }];
  public salesBgColor = { domain: ['#4c3954'] };

  public likes = [{ name:'Arrives en cours', value:6 }];
  public likesBgColor = { domain: ['#798282'] };

  public downloads = [{ name:'Internes en cours', value:4 }];
  public downloadsBgColor = { domain: ['#00a09d'] };
