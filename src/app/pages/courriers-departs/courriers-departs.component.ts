...
import {DxTreeViewComponent, getElement} from 'devextreme-angular';
...
@Component({
  selector: 'app-courriers-departs',
  templateUrl: './courriers-departs.component.html',
  styleUrls: ['./courriers-departs.component.scss','./material.css'],
  providers: [CheckBoxSelectionService]
})

export class CourriersDepartsComponent implements OnInit {
  test1: any = false;
  ...
  returnroutage($event, dataform) {
    ...
    if (this.departService.ajoutercourrier == 'newcourrierArriver') {
      ...
      this.alfrescoApi.createFolder(this.identifcourrier, null, this.parentNodeRef)
         ...
         this.saveRoutage(document,resultNextTask)
              },
          );
