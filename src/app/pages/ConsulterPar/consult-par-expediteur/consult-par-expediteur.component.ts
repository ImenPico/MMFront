...
@Component({
  selector: 'app-consult-par-expediteur',
  templateUrl: './consult-par-expediteur.component.html',
  styleUrls: ['./consult-par-expediteur.component.scss']
})
export class ConsultParExpediteurComponent implements OnInit {
