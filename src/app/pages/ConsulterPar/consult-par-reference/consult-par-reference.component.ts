...
@Component({
  selector: 'app-consult-par-reference',
  templateUrl: './consult-par-reference.component.html',
  styleUrls: ['./consult-par-reference.component.scss']
})
export class ConsultParReferenceComponent implements OnInit {
