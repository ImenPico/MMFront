...
@Component({
  selector: 'app-traitement-par-sous-couvert',
  templateUrl: './traitement-par-sous-couvert.component.html',
  styleUrls: ['./traitement-par-sous-couvert.component.scss']
})
export class TraitementParSousCouvertComponent implements OnInit {
  test1: any = false;
