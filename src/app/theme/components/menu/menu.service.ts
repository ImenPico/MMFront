...
import {profileAdminApplication, profileMMUser, verticalMenuItems} from './menu';
...
export class MenuService {
  ...
  constructor(private location:Location, 
    ...
    public getProfileAdmmin():Array<Menu>{
        return profileAdminApplication;
    }
    public getUserMailManager():Array<Menu>{
        return  profileMMUser
    }
